            ...
            <div className="mx-auto my-12 w-[90%] md:w-[50%] lg:w-[50%] xl:w-[50%]
             ...
             overflow-y-auto bg-white shadow-sm rounded-md relative p-4 ">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col">
                    ...
                    <TextareaAutosize minRows={3} placeholder="[optional] Backup codes, Security Keys, etc... " value={optional} onChange={e => setOptional(e.target.value)} className="mt-4 outline-none border-b-2 border-gray-700" />
